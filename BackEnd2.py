...
class JustHungry2(object):
    ...
    def update(self, data):
        self.Orders = data
        print("Updating BackEnd2", self.Orders)


BackEnd1 = Pyro4.Proxy("PYRONAME:BackEnd0")
BackEnd2 = Pyro4.Proxy("PYRONAME:BackEnd1")

daemon = Pyro4.Daemon()
ns = Pyro4.locateNS()
instance = JustHungry2()
uri = daemon.register(instance)

ns.register("BackEnd2", uri)

print("BackEnd2 Ready.")
